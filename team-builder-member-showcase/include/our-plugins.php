...
<div class="wrap ig-our-plugins-wrap">
    <header class="ig-our-plugins-header">
        <div class="ig-header-content">
            <h1><?php esc_html_e( 'Our WordPress Ecosystem', 'team-builder-member-showcase' ); ?></h1>
            <p><?php esc_html_e( 'Discover powerful tools designed to simplify your WordPress workflow. High-performance plugins built by A WP Life.', 'team-builder-member-showcase' ); ?></p>
        </div>
        <div class="ig-header-stats">
            <div class="ig-stat-item">
                <span class="ig-stat-value">500k+</span>
                <span class="ig-stat-label"><?php esc_html_e( 'Active Installs', 'team-builder-member-showcase' ); ?></span>
            </div>
        </div>
    </header>
    ...
    <nav class="ig-plugins-filters">
        <button class="ig-filter-btn active" data-filter="all"><?php esc_html_e( 'All Plugins', 'team-builder-member-showcase' ); ?></button>
        <button class="ig-filter-btn" data-filter="new"><?php esc_html_e( 'New Releases', 'team-builder-member-showcase' ); ?></button>
        <button class="ig-filter-btn" data-filter="popular"><?php esc_html_e( 'Most Popular', 'team-builder-member-showcase' ); ?></button>
        <button class="ig-filter-btn" data-filter="marketing"><?php esc_html_e( 'Marketing & Growth', 'team-builder-member-showcase' ); ?></button>
        <button class="ig-filter-btn" data-filter="social"><?php esc_html_e( 'Social Media', 'team-builder-member-showcase' ); ?></button>
        <button class="ig-filter-btn" data-filter="technical"><?php esc_html_e( 'Technical Tools', 'team-builder-member-showcase' ); ?></button>
        
        <a href="<?php echo esc_url( add_query_arg( 'refresh_plugins', '1' ) ); ?>" class="ig-refresh-link" title="<?php esc_attr_e( 'Sync with WordPress.org', 'team-builder-member-showcase' ); ?>">
	...
	<?php if ( empty( $filtered_plugins ) ) : ?>
        <div class="ig-error-wrap">
            ...
            <h2><?php esc_html_e( 'Unable to fetch our plugins', 'team-builder-member-showcase' ); ?></h2>
            <p><?php esc_html_e( 'We encountered an error connecting to WordPress.org. Please try again later.', 'team-builder-member-showcase' ); ?></p>
        ...
        <div class="ig-plugins-grid" id="ig-plugins-container">
			<?php foreach ( $filtered_plugins as $plugin ) :
                ...
                <div class="ig-plugin-card <?php echo esc_attr( $cat_classes ); ?>">
					<?php if ( $is_installed ) : ?>
                        <div class="ig-plugin-status"><?php esc_html_e( 'INSTALLED', 'team-builder-member-showcase' ); ?></div>
					<?php endif; ?>
                    ...
                    <div class="ig-plugin-content">
                        ...
                        <div class="ig-plugin-actions">
                            <a href="<?php echo esc_url( 'https://wordpress.org/plugins/' . $plugin['slug'] . '/' ); ?>" target="_blank" class="ig-btn ig-btn-secondary">
								<?php esc_html_e( 'Details', 'team-builder-member-showcase' ); ?>
                            </a>
